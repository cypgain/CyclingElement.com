    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card alert alert-primary" role="alert">
                <h5>Tip!</h5>
                <p>We advise you to weigh yourself after waking up, to have the same conditions.</p>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body pb-1">
            <div class="feature-products">
                <form method="POST" action="{{ route('weight.add') }}">
                    @csrf
                    ...
                    <div class="form-group row w-100">
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="weight" placeholder="Enter your current weight" />
                        </div>
